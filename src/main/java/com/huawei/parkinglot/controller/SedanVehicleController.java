...
@RestController
@RequestMapping(value = "/sedan", produces = MediaType.APPLICATION_JSON_VALUE)
public class SedanVehicleController implements VehicleController {

    @Autowired
    @Qualifier("sedanVehicleService")
